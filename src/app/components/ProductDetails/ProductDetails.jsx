        ...
        <div className="product-details-main-info">
          ...
          <div className="product-details-specifications-container">
            <div className="product-details-specification-row">
              <span className="product-details-specification-label">Botanical Name :</span>
              <span className="product-details-specification-value">{product.botanicalName}</span>
            </div>
            <div className="product-details-specification-row">
              <span className="product-details-specification-label">Family :</span>
              <span className="product-details-specification-value">{product.family}</span>
            </div>
            <div className="product-details-specification-row">
              <span className="product-details-specification-label">Commercial Part :</span>
              <span className="product-details-specification-value">{product.commercialPart}</span>
            </div>
          </div>
          ...
          <button className="product-details-enquire-button">Enquire Now</button>
        </div>
      </div>

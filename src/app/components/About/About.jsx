        ...
        <div className="About-text">
          ...
          <div className="About-paragraph-container">
              <p className="About-para">
                ...
                With deep expertise in processing, administration, marketing,
                and exporting, we proudly deliver premium-quality spices that
                bring flavor and authenticity to every kitchen. With a passion
                for purity and authenticity, we source the finest spices from
                trusted farms and regions known for their rich heritage of
                cultivation. From the earthy warmth of cumin to the vibrant zest
